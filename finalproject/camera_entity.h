...
public:
    ...
    camera_entity(glm::vec3 pos = glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3 up = glm::vec3(0.0f, 1.0f, 0.0f), float yaw = YAW, float pitch = PITCH)
        ...
        movement_speed(SPEED), mouse_sensitivity(SENSITIVITY), near1(1.0f), far1(300.0f), projection_angle(80.0f),
        projection_width(1280), projection_height(720)
    {
    ...
    {
        return glm::perspective(glm::radians(projection_angle), projection_width / projection_height, near1, far1);
    }

    glm::vec2 get_frustum() const
    {
        return glm::vec2(near1, far1);
    }
